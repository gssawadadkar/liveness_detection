...
from imutils import face_utils  # Add this import
import numpy as np
import imutils
import dlib
import cv2
...
def verify_liveness(cap, detector, predictor):
    required_blinks = 3  # Adjust as needed
    blink_count = 0
    consecutive_frames = 0
    EYE_AR_CONSEC_FRAMES = 3  # Adjust as needed

    print("Please perform {} blinks for liveness verification.".format(required_blinks))
